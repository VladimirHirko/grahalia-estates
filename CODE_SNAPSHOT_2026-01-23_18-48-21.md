# Code snapshot (2026-01-23T18:48:21)
Всего файлов: 113
        ...
        <form action={updateBase}>
          ...
          <div style={grid3}>
            <Field label="Deal type">
              <select name="dealType" defaultValue={prop.deal_type ?? "sale"} style={input}>
      ...
      <form action={create} style={{ marginTop: 18 }}>
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <Field label="Deal type">
              <select name="dealType" defaultValue="sale" style={inputStyle}>
                <option value="sale">Sale</option>
                <option value="rent">Rent</option>
              </select>
            </Field>
...
```json
{
  ...
  "scripts": {
    ...
    "db:seed:features": "dotenv -e .env.local -- sh -lc 'psql \"$DATABASE_URL\" -f db/migrations/0004_seed_features.sql'"
  },
  "dependencies": {
    "drizzle-orm": "^0.45.1",
    "next": "16.1.2",
