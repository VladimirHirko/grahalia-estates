# Code snapshot (2026-01-26T16:28:54)
Всего файлов: 122
...
/* SOLD — диагональный штамп */
.soldStamp {
  position: absolute;
  top: 110px;
  left: -60px;              /* уводим влево, чтобы диагональ выглядела “штампом” */
  z-index: 4;

  width:290px;             /* ширина ленты */
  height: 36px;
